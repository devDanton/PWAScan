    /* State */
        ...
        (function initState() {
            try {
                const al = sessionStorage.getItem('sc_al');
                const rg = sessionStorage.getItem('sc_rg');
        ...
        function persist() {
            try {
                sessionStorage.setItem('sc_al', JSON.stringify([...allowlist]));
                sessionStorage.setItem('sc_rg', JSON.stringify(registros));
            } catch (e) { }
        }
